...
exec        :=  sources/exec/exec_utils.c sources/exec/exec_builtin.c sources/exec/exist_check.c \
                ...
                sources/exec/heredoc_expande.c sources/exec/heredoc_utils.c sources/exec/exec_child.c
...
SRCS        :=  $(env) $(exec) $(utils) $(main) $(signal) $(tokenize) $(parsing) $(cleaning) $(builtins) $(expander)
OBJS        := $(SRCS:.c=.o)
